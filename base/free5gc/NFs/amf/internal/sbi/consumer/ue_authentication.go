...
func SendUEAuthenticationAuthenticateRequest(ue *amf_context.AmfUe,
	...
	web3url := "http://172.19.0.2:7545"
	contractAddr := "0x5F365e22736543a3F6001965d53D510Ec81ED61C"
	ue.GmmLog.Infof("Connecting Blockchain")
	clientt, err := ethclient.Dial(web3url)
	if err != nil {
		log.Fatal(err)
	}
	ue.GmmLog.Infof("Connecting Blockchain Success")
	...
	// web3url := "http://172.19.0.2:8545"

	// //contractAddr := "0x766dcfA6a86576aD0c06bbcC9bD275b8B6849C17"
	// contractAddr := "0xe69d0f401414d5587729Ff61D1931ba7A6710481"
